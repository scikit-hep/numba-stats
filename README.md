...
- `integrate`: integral of the probability density over an interval, more efficient and accurate than `cdf(hi) - cdf(lo)`. Unlike the other functions, it takes scalars and returns a scalar
